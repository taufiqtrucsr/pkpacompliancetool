$(document).ready(function () {
	...
	$("#editprojectstep1").click(function(){
		var lastinsertid = $("#ngo_project_id").val();
		 //alert(lastinsertid);
    ...
    //    $("#pro-step-2-btn").attr('disabled', 'disabled');
       ...
       $("#project-step-1").css("display", "block");
		...
		setTimeout(function() {
		window.location.href =noHashURL+'#project-step-1';
		});
	});

	$("#editprojectstep2").click(function(){
		var lastinsertid = $("#ngo_project_id").val();
		 //alert(lastinsertid);
		console.log(lastinsertid);
	   $("#pro-step-3-btn").removeClass('btn-primary').addClass('btn-default');
	...
	$("#editprojectstep3").click(function(){
		var lastinsertid = $("#ngo_project_id").val();
		 //alert(lastinsertid);
		console.log(lastinsertid);
	   $("#pro-step-4-btn").removeClass('btn-primary').addClass('btn-default');
	...
	$("#editprojectstep4").click(function(){
		var lastinsertid = $("#ngo_project_id").val();
		 //alert(lastinsertid);
		console.log(lastinsertid);
	   $("#pro-step-5-btn").removeClass('btn-primary').addClass('btn-default');
	...
	$("#editprojectstep5").click(function(){
		 var lastinsertid = $("#ngo_project_id").val();
		 //alert(lastinsertid);
		 console.log(lastinsertid);		
		$("#pro-step-6-btn").removeClass('btn-primary').addClass('btn-default');
	  ...
	  //       },
    	...
    	submitHandler: function(form) { 	
            ...
            success: function(response) {
                ...
                if(response.flag == 1) {
                //    $("#pro-step-1-btn").removeClass('btn-primary').addClass('btn-primary');
                   $("#pro-step-2-btn").removeClass('btn-default').addClass('btn-primary');
...
//this code written for programme date
$('#proDateFromm').datepicker({
	format: "dd-mm-yyyy",
	autoclose: true,
	todayHighlight: true,
	toggleActive: true,
...
function DeleteProjectPrograme(id)
{	
	//alert(id);
	if(id != ""){
		$.ajax({
		url: BASE_URL+'project/projectprogrameDelete/'+id,
		type: 'POST',
		method: 'POST',
		dataType: 'json',
		contentType: false,
